...
const Cadastro: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-secondary">
      <h1 className="text-4xl font-bold text-primary mb-8">Cadastro</h1>
      <form className="w-full max-w-lg bg-white p-8 rounded-lg shadow-md">
        <div className="mb-4">
          <label htmlFor="name" className="block text-text text-sm font-bold mb-2">Nome Completo</label>
          <input type="text" id="name" className="shadow appearance-none border rounded w-full py-2 px-3 text-text leading-tight focus:outline-none focus:shadow-outline" />
        </div>
        <div className="mb-4">
