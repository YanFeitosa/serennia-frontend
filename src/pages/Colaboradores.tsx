    ...
    <div className="space-y-4">
      <header className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Button className="font-semibold bg-secondary text-secondary border-2 border-primary font-bold py-4 px-4 rounded-lg w-50" onClick={() => navigate('/colaboradores/novo')}>+ Novo Colaborador</Button>
        </div>
      </header>
